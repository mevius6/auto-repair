...
// const ICON_HEX_COLOR = '001f3f';
const ICON_GRADIENT = `%3E%3Cdefs%3E%3ClinearGradient id='Grad' gradientUnits='userSpaceOnUse' x1='0%25' y1='0%25' x2='100%25' y2='0%25' gradientTransform='rotate(45)'%3E%3Cstop offset='0%25' stop-color='%237f13f4' /%3E%3Cstop offset='100%25' stop-color='%23f4107f' /%3E%3C/linearGradient%3E%3C/defs%3E`;
// fa
  ...
  <style>
    *,::after,::before{box-sizing:border-box}:host{contain:content;display:block}form{padding:0;background:transparent;color:inherit}fieldset{border:0;margin:0;padding:0}legend{font:var(--${NAME}-legend-font,inherit);padding:0;margin-block-end:0.5rem}input,label{cursor:pointer}
    ...
    input:focus-visible + label {
      --${NAME}-border-color: hsl(var(--accent));
      /*
      outline: hsl(var(--accent)) dotted thin;
      outline-offset: 2px; */
    }
